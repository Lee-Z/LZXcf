...
-(CGFloat)getSpaceLabelHeight:(NSString *)str withWidh:(CGFloat)width
{
    ...
    paragphStyle.lineBreakMode=NSLineBreakByCharWrapping;
    
    NSDictionary *dic=@{
                        
                    NSFontAttributeName:[UIFont systemFontOfSize:20], NSParagraphStyleAttributeName:paragphStyle, NSKernAttributeName:@1.0f
